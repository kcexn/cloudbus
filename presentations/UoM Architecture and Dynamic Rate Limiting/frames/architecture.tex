\begin{frame}
	...
	\only<2>{
		\begin{block}{Design Philosophy}
			Cloudbus improves the performance and extends the capabilities of existing client-server applications by encapsulating application %
			data at the session-layer in a cloudbus data frame and then making transport and network decisions for the application based %
