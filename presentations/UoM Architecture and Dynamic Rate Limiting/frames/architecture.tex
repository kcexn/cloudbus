		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{block}{Cloudbus Transport}
					\footnotesize
					\begin{itemize}
						\item Cloudbus encapsulates uniquely identifiable user data streams in session-layer chunks.
						\item Each chunk is stamped with a UUID, and cloudbus internally routes application traffic using UUIDS instead of the traditional 
						5-tuple.
						\item 
					\end{itemize}
					\normalsize
