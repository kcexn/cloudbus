\begin{frame}
	...
	\only<1>{
		\begin{block}{Open-source and GPL licensed.}
			Cloudbus is open-source and is Affero GPL licensed. Students:
			\begin{itemize}
				\item Will retain the copyright for any proposed merge requests to the cloudbus project.
				\item Will be listed as a \emph{contributor} for approved merge requests.
				\item Depending on size and complexity of the submission, will also be listed as a \emph{maintainer} for approved merge requests.
