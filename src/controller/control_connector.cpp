...
namespace cloudbus {
    namespace controller {
        ...
        control_connector::norths_type::iterator control_connector::make(norths_type& n, const registry::address_type& address){
        ...
        control_connector::souths_type::iterator control_connector::make(souths_type& s, const registry::address_type& address){
