    ...
    namespace proxy {
        ...
        class proxy_connector: public basic_connector<proxy_marshaller, handler_type>
        {
            ...
            private:
                ...
                void _north_connect_write(south_type::stream_type& s, north_type::stream_ptr& nsp, marshaller_type::north_format& buf);
                void _north_connect_handler(shared_north& interface, north_type::stream_ptr& nsp, marshaller_type::north_format& buf);
