...
namespace cloudbus{
    namespace proxy {
        ...
        proxy_marshaller::north_buffers::iterator proxy_marshaller::_unmarshal(const north_type::stream_type& stream){
        ...
        proxy_marshaller::south_buffers::iterator proxy_marshaller::_marshal(const south_type::stream_type& stream){
