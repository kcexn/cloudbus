...
namespace cloudbus{
    namespace segment {
        class segment_marshaller : public basic_marshaller<cbus_interface, service_interface>
        {
            public:
            ...
            protected:
                ...
                virtual south_buffers::iterator _marshal(const south_type::stream_type& stream) override;
        };      
    }
}
#endif